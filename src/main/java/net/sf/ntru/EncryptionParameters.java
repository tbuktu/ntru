...
public class EncryptionParameters {
    ...
    public static final EncryptionParameters EES1171EP1 = new EncryptionParameters(1171, 2048, 106, 106, 256, 10, 20, 15, new byte[] {0, 6, 4}, true);   // security>256, key size / speed tradeoff
    ...
    public static final EncryptionParameters APR2011_743 = new EncryptionParameters(743, 2048, 248, 220, 256, 9, 27, 14, new byte[] {0, 7, 105}, false);   // security=256
